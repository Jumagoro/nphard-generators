...
class HCPSynH1Factory(GraphFactory):
    ...
    def __init__(self, n_nodes, density):
        ...
        # TODO: Density is now a bit higher due to the additional edges of the bootle neck
        # TODO: Solution: Calculate density for remaining connections after inserting bottle neck
